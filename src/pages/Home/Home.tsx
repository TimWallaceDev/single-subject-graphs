        ...
        <main className="home">
            ...
            <section className="hero">
                <div className="hero__left">
                    ...
                    <p className="hero__copy">Spend less time creating graphs, and more time analyzing the data. Single Subject Graphs generates graphs from your data sheets instantly. All data remains on your device, so you never have to worry about your data. Automatically formatted to meet APA guidelines. Available for Multiple Baseline Graphs, or Reverse Baseline Graphs.</p>
                </div>
