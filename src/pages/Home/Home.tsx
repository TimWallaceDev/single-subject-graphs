        ...
        <main className="home">
            ...
            <section className="hero">
                <div className="hero__left">
                    <h1 className="hero__title">Generate Graphs from Datasheets</h1>
                    <h2 className="hero__subtitle">Spend less time creating graphs, and more time analyzing the data.</h2>
                    <ul className="hero__copy">
                        <li>
                            Single Subject Graphs generates graphs from your data sheets instantly.
                        </li>
                        <li>
                            All data remains on your device, so you never have to worry about your data.
                        </li>
                        <li>
                            Automatically formatted to meet APA guidelines. Available for Multiple Baseline Graphs, or Reverse Baseline Graphs.
                        </li>
                    </ul>
                </div>
